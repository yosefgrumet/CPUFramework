...
namespace CPUFramework
{
    public class SQLUtility
    {
        ...
        public static int GetValueFromFirstRoAsInt(DataTable dt, string columnname)
        {
            int value = 0;
            if (dt.Rows.Count > 0)
            {
        ...
        public static string GetValueFromFirstRoAsString(DataTable dt, string columnname)
        {
            string value = "";
            if (dt.Rows.Count > 0)
            {
